"""Generate difficult, physics-inspired synthetic sensor trajectories for Farmer ML V1.
...
DEFAULT_OUTPUT = PROJECT / "outputs" / "farmer_synthetic_v1"
SEED = 20260823
WINDOW_SIZE = 32
TOTAL_STEPS = 96
DT_HOURS = 0.25
...
def main() -> None:
    ...
    if args.samples < 900:
        raise ValueError("Use at least 900 trajectories for the V1 split and OOD evaluation.")
    ...
    metadata = {
        "dataset_type": "synthetic_sensor_trajectories_v1",
