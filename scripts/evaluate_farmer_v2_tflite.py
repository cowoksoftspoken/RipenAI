"""Evaluate the V2 TFLite export on standard and OOD synthetic splits."""
...
DEFAULT_CONFIG = PROJECT / "outputs" / "farmer_model_v2_cuda" / "farmer_v2_model_config.json"
DEFAULT_MODEL = PROJECT / "outputs" / "farmer_model_v2_tflite" / "farmer_risk.tflite"
...
def main() -> None:
    ...
    # V2 metadata exposes the complete feature contract for Android. The
    ...
    output = args.output or args.model.with_name("farmer_v2_tflite_evaluation.json")
